...
def interactions():
    ...
    # current_app.logger.info(f'content is {json.dumps(content, indent=4)}')
    ...
    if interaction_type == InteractionType.PING:
        ...
        return handle_message_interaction(
    ...
    if command_name == "test":
        ...
        try:
            ...
            if not artists_for_user:
                return jsonify({
                    "type": InteractionCallbackType.CHANNEL_MESSAGE_WITH_SOURCE,
                    "data": "Thanks for adding your first artist! Rate another artist to create a relative ranking.",
                })
